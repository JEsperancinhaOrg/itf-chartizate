...
public class PencelizerCharacterImgTest {
	...
	public void testGetBg() throws Exception {
		final PencelizerCharacterImg<Color> character = new PencelizerCharacterImg<>(null, Color.BLACK, 0, ' ');
		assertEquals(Color.BLACK, character.getBg());
	}

	@Test
	public void testGetFg() throws Exception {
		final PencelizerCharacterImg<Color> character = new PencelizerCharacterImg<>(Color.BLACK, null, 0, ' ');
	...
	public void testGetWidth() throws Exception {
		final PencelizerCharacterImg<Color> character = new PencelizerCharacterImg<>(null, null, 500, ' ');
