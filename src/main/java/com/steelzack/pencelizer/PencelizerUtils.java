...
public class PencelizerUtils {
	...
	private static final String[] unicodeDesignationsJava7 = new String[] { //
			"BASIC_LATIN", //
			"LATIN_1_SUPPLEMENT", //
			"LATIN_EXTENDED_A", //
			"LATIN_EXTENDED_B", //
	...
	public static List<UnicodeBlock> getAllUniCodeBlocksJava8() {
	...
	public static List<UnicodeBlock> getAllUniCodeBlocksJava7() {
		final List<UnicodeBlock> unicodeBlockList = new ArrayList<>();
